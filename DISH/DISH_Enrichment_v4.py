...
file_name_acdm_xlsx = today_date + ' - 20220825113059_v4' + '.xlsx'
...
file_name_aoi_xlsx = today_date + ' - 20%_AOI_SITE_INFO_v4' + '.xlsx'
...
file_name_enrich_xlsx = today_date + ' - Enrichment_table_v4' + '.xlsx'
...
file_name_enrich_csv = today_date + ' - Enrichment_table_v4' + '.csv'
file_exp_path_enrich_table = 'C:/Users/alvaro.mendoza/OneDrive - RADCOM Ltd/_DISH/DISH_Enrichment/Script_Outputs/'
file_exp_path_enrich_csv = file_exp_path_enrich_table + file_name_enrich_csv

file_name_meta_txt = today_date + ' - Enrichment_meta_data_v4' + '.txt'
