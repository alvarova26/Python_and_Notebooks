...
echo "Probe validation" >>/tmp/shortHC_output.txt
echo "                                                           "  >>/tmp/shortHC_output.txt
echo "                                                           "  >>/tmp/shortHC_output.txt


sh /home/deployment/Probe_DataValidationChecks.sh > /tmp/DISH_Probe_status.txt
...
echo "                                                           "  >> /tmp/DISH_system_hc_status_new.txt
echo "                                                           "  >> /tmp/DISH_system_hc_status_new.txt
echo "################################################################" >> /tmp/DISH_system_hc_status_new.txt
echo "End of script " >> /tmp/DISH_system_hc_status_new.txt
echo "################################################################" >> /tmp/DISH_system_hc_status_new.txt
